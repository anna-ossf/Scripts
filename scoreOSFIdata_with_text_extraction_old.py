...
def _init_topics():
    ...
    return ['topic_3D_printing','topic_agriculture','topic_artificial_intelligence','topic_baby_boomers','topic_big_data',
            ...
            'topic_computer_vision','topic_consumerpreference', 'topic_financial','topic_cybersecurity','topic_demographics','topic_development',
            ...
            'topic_telecom', 'topic_smartphones', 'topic_quantum', 'topic_nanotech', 'topic_saas', 'topic_waste_management', 'topic_cancer_treatment',
            'topic_vegan', 'topic_adult_entertainment']
