...
def _init_topics():
    ...
    """return ['topic_military_spending', 'topic_outsourcing', 'topic_IPOs', \
            'topic_cybersecurity', 'topic_fossil_free', 'topic_cars', \
            'topic_driverless_cars', 'topic_organic', 'topic_human_rights', \
            'topic_pets', 'topic_global_goals', 'topic_travel', \
            'topic_home_ownership', 'topic_food', 'topic_streaming', \
            'topic_environmental', 'topic_health_tech', 'topic_3D_printing', \
            'topic_coal', 'topic_artificial_intelligence', 'topic_esg', \
            'topic_sensors', 'topic_women', 'topic_social', 'topic_gaming', \
            'topic_payments', 'topic_ethereum', 'topic_music', \
            'topic_blockchain', 'topic_social_media', 'topic_logistics', \
            'topic_climate_change', 'topic_drip_irrigation', 'topic_lgbt', \
            'topic_computer_vision', 'topic_gen_x', 'topic_bitcoin_cash', \
            'topic_water', 'topic_big_data', 'topic_millenials', \
            'topic_electric_vehicle', 'topic_spinoffs', 'topic_qsr', \
            'topic_solar_energy', 'topic_demographics', 'topic_wind_energy', \
            'topic_cloud_computing', 'topic_tech', 'topic_mri', \
            'topic_geothermal', 'topic_luxury', 'topic_consumerpreference', \
            'topic_philantropy', 'topic_governance', 'topic_nuclear', \
            'topic_drone', 'topic_employeetreatment', 'topic_robotics', \
            'topic_immunotherapy', 'topic_sports', 'topic_virtual_reality', \
            'topic_ripple', 'topic_lending_platforms', 'topic_shale', \
            'topic_coins', 'topic_wealthtech', 'topic_financial', \
            'topic_medical_devices', 'topic_catholic', 'topic_military', \
            'topic_natural_language_processing', 'topic_clean_energy', \
            'topic_insurtech', 'topic_stemcell', 'topic_renewable_energy', \
            'topic_seniors', 'topic_bitcoin', 'topic_development', \
            'topic_roboadvisors', 'topic_wearable_tech', 'topic_leisure', \
            'topic_fintech', 'topic_baby_boomers', 'topic_hydro', \
            'topic_entrepreneurship', 'topic_gender', 'topic_iot', \
            'topic_buybacks', 'topic_marijuana', 'topic_wellness', \
            'topic_agriculture', 'topic_cleantech', 'topic_manufacturing', \
            'topic_ecommerce', 'topic_vice', 'topic_precision_agriculture']"""
    return ['topic_military_spending', 'topic_outsourcing', 'topic_ipo', 'topic_cybersecurity', 'topic_fossilfree', 'topic_cars', 'topic_driverlessvehicle', 'topic_organic', 'topic_humanrights', 'topic_pets', 'topic_globalgoals', 'topic_travel', 'topic_home_ownership', 'topic_food', 'topic_streaming', 'topic_environmental', 'topic_health_tech', 'topic_3D_printing', 'topic_coal', 'topic_artificial_intelligence', 'topic_esg', 'topic_sensors', 'topic_women', 'topic_social', 'topic_gaming', 'topic_payments', 'topic_ethereum', 'topic_music', 'topic_blockchain', 'topic_social_media', 'topic_logistics', 'topic_climatechange', 'topic_drip_irrigation', 'topic_lgbtq', 'topic_computervision', 'topic_genx', 'topic_bitcoin_cash', 'topic_water', 'topic_big_data', 'topic_millenials', 'topic_electric_vehicle', 'topic_spinoffs', 'topic_qsr', 'topic_solarenergy', 'topic_demographics', 'topic_windenergy', 'topic_cloud', 'topic_tech', 'topic_mri', 'topic_geothermal', 'topic_luxury', 'topic_consumerpreference', 'topic_philantropy', 'topic_governance', 'topic_nuclear', 'topic_drone', 'topic_employeetreatment', 'topic_robotics', 'topic_immunotherapy', 'topic_sports', 'topic_virtualreality', 'topic_ripple', 'topic_lendingplatforms', 'topic_shale', 'topic_coins', 'topic_wealthtech', 'topic_financial', 'topic_medical_devices', 'topic_catholic', 'topic_military', 'topic_natural_language_processing', 'topic_cleanenergy', 'topic_insurtech', 'topic_stemcells', 'topic_renewable_energy', 'topic_seniors', 'topic_bitcoin', 'topic_development', 'topic_roboadvisors', 'topic_wearable_tech', 'topic_leisure', 'topic_fintech', 'topic_babyboomers', 'topic_hydro', 'topic_entrepreneurship', 'topic_gender', 'topic_iot', 'topic_buybacks', 'topic_marijuana', 'topic_wellness', 'topic_agriculture', 'topic_cleantech', 'topic_manufacturing', 'topic_ecommerce', 'topic_vice', 'topic_precision_agriculture']
        ...
        for index, row in data.iterrows():
            ...
            for elem in tree:
                ...
                if extraction == data.loc[index, 'Extraction']:
                    topics = [key for key, value in elem.attrib.items() if 'prop_topic_' in key]
...
def _add_weights_to_scores(data, topics, docType):
    ...
    for topic in topics:
        ...
        if docType.lower() == 'batch':
            ...
            colName = 'eventName'
        data[topic] = pd.np.where(data[colName].str.contains(r'(?i)Catch', regex=True), data[topic]*scoreDict['Catch'], data[topic])
        data[topic] = pd.np.where(data[colName].str.contains(r'(?i)Forecast', regex=True), data[topic]*scoreDict['Forecast'], data[topic])
    return data
